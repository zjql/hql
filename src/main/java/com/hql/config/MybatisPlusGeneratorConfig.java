...
public class MybatisPlusGeneratorConfig {
    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\zz\\Myhql\\hql";

    //基本包名
    private static String basePackage = "com.hql";
    //作者
    private static String authorName = "zj";
    //要生成的表名
    private static String[] tables = {"student_info"};
    //table前缀
